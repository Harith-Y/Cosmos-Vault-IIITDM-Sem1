# Cosmos Vault — Semester 1

Welcome to the **Cosmos Vault – Semester 1** repository!  
This repo contains curated academic materials, lecture notes, assignments, and projects for **Semester 1** of the IIITDM coursework collection.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/<your-username>/Cosmos-Vault-IIITDM-Sem1.git
   cd Cosmos-Vault-IIITDM-Sem1
   ```
...
To save bandwidth, use Git’s sparse checkout to clone just specific folders:
  ```bash
  git clone --filter=blob:none --no-checkout https://github.com/Harith-Y/Cosmos-Vault-IIITDM-Sem1.git
  cd Cosmos-Vault-IIITDM-Sem1
